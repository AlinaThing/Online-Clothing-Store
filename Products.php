...
$query_Recordset1 = "SELECT ItemName, Description, Size, Image, Price, Discount, Total FROM item_master WHERE CategoryId = $colname_Recordset1";
...
<div id="wrapper">
  ...
  <div id="content">
    ...
    <table width="100%" border="0" cellspacing="3" cellpadding="3">
      ...
      <tr>
        <td><p><img src="img/Jeans1.jpg" alt="box" width="100" height="100" hspace="10" align="left" class="imgleft" title="box" /></p></td>
        <td><p><img src="img/bleasure2.jpg" alt="box" width="100" height="100" hspace="10" align="left" class="imgleft" title="box" /></p></td>
        <td><p><img src="img/tshirt1.jpg" alt="box" width="100" height="100" hspace="10" align="left" class="imgleft" title="box" /></p></td>
      </tr>
      <tr>
