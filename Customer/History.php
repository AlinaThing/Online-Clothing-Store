  ...
  <div id="content">
    ...
    <table width="100%" border="1" bordercolor="#003300" >
      <tr>
        ...
        <td bgcolor="#4B692D" class="style10 style3"><strong>Feedback</strong></td>
      </tr>
      <?php
...
$Size=$row['Size'];
$Image=$row['Image'];
/* $star = mysqli_query($con, "SELECT * FROM item_master WHERE ItemName = $ItemName");
$stars = mysqli_fetch_array($star);
echo $star['ItemName']; */
?>
      <tr>
        ...
        <td class = "style3"><div align="left" class="style9 style5"><strong><a href = "feedback.php?item_name=<?php echo $ItemName; ?>"> Feedback </a></strong></div></td>
      </tr>
      <?php
}
